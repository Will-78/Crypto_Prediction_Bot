...
def make_decision(tick_data, sma, rs, rsi, vwap, book_order):
    ...
    completion = openai.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are a crypto specialist and can make crypto suggestions off data retrieved from Binance",
            },
            {
                "role": "user",
                "content": f"Based off this information provided make a suggested plan of action like selling, holding, or buying:"
